...
pub(crate) const EXPONENT_BIAS: u64 = 0x3ff;
pub(crate) const EXPONENT_MASK: u64 = 0x7ff;
pub(crate) const MANTISSA_SIZE: u64 = 52;
pub(crate) const CONST_EXPONENT_BITS: u64 = 0x300;
pub(crate) const STATIC_EXPONENT_BITS: u64 = 4;
pub(crate) const DYNAMIC_EXPONENT_BITS: u64 = 4;
pub(crate) const DATASET_EXTRA_ITEMS: usize = 0x7ffff;
